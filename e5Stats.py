...
def do_something(bb):
    ...
    savedValues = np.load("./e5/" + str(pairList[bb][0]) + "dp" + str(pairList[bb][1]) + "tr.npy", allow_pickle=True)
    ...
    # desPts = datum[0]
    # observables = datum[1]
    desPts = np.load(str(savedValues[0]) + ".npy", allow_pickle=True)
    observables = np.load(str(savedValues[11]) + ".npy", allow_pickle=True)
    ...
    plt.title(r"$\epsilon$5 Number of design points: " + str(totDesPoints) + ", Number of trento runs: " + str(nTrento))
    ...
    AIC = -2*np.log(maxPost) + 4
    BIC = -2*np.log(maxPost) + 2*np.log(totDesPoints)
    AICc = AIC + 12/(totDesPoints-3)

    subtitle = "NormP: " + str(normish) + ", Evidence: " + str(vol1) + ", AIC: " + str(AIC) + \
               ", BIC: " + str(BIC) + ", AICc: " + str(AICc)

    print(str(pairList[bb]) + " normP(truth): " + str(normish))
    print(str(pairList[bb]) + " Evidence: " + str(vol1))
    print(str(pairList[bb]) + " AIC: " + str(AIC))
    print(str(pairList[bb]) + " BIC: " + str(BIC))
    print(str(pairList[bb]) + " AICc: " + str(AICc))
