...
obsTruths = trentoRun(paramTruths, 8192, uncert=True)
...
def saving(aa):
    ...
    accessFileName = "./2to13/" + str(totDesPts) + "dp" + str(nTrentoRuns) + "tr"
    dpFileName = "./2to13/" + str(totDesPts) + "dp" + str(nTrentoRuns) + "trDP"
    obsFileName = "./2to13/" + str(totDesPts) + "dp" + str(nTrentoRuns) + "trObs"
