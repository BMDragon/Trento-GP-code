...
paramLabels = np.array(["Reduced thickness", "Nucleon-Width", "Fluctuation", "Cross-Section"])
paramMins = np.array([0, 0.5, 0.5, 4.0])  # [param1_min, param2_min, ..., paramN_min]
paramMaxs = np.array([0.5, 1.2, 4.0, 10.0])  # [param1_max, param2_max, ..., paramN_max]
obsLabels = np.array([r"$\epsilon$2", r"$\epsilon$3"])
paramTruths = np.array([0.314, 0.618, 1.234, 4.669])
dataUncert = 65536
