...
obsTruths = trentoRun(paramTruths, 262144, uncert=True)
...
def saving(aa):
    ...
    accessFileName = "./2to18/" + str(totDesPts) + "dp" + str(nTrentoRuns) + "tr"
    dpFileName = "./2to18/" + str(totDesPts) + "dp" + str(nTrentoRuns) + "trDP"
    obsFileName = "./2to18/" + str(totDesPts) + "dp" + str(nTrentoRuns) + "trObs"
